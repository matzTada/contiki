...
for j in 80 70 60 50 40 30 20 10
do
  echo entering
  cd scenario
  pwd
  ...
  do
    ...
    java -jar $HOME/contiki/tools/cooja/dist/cooja.jar -nogui=$HOME/contiki/examples/ipv6/my-LFC-timed-bugfix-periodic/scenario/ladder_NO.csc -contiki=$HOME/contiki/
