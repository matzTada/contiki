...
do
  ...
  python xml_re_writer.py ladder_NO-re4.csc 100 $j
  ...
  do
    ...
    java -jar $HOME/contiki/tools/cooja/dist/cooja.jar -nogui=$HOME/contiki/examples/ipv6/my-LFC-tb-periodic-Normal-ReTx/scenario/ladder_NO-re4.csc -contiki=$HOME/contiki/
