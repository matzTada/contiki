...
do
  ...
  do
    ...
    java -jar $HOME/contiki/tools/cooja/dist/cooja.jar -nogui=$HOME/contiki/examples/ipv6/my-LFC-timed-bugfix-periodic-overhear-sim-UDGM/scenario/overhearing_udgm_NO-re6.csc -contiki=$HOME/contiki/
