...
do
    ...
    timeout -sKILL 7200 java -jar $HOME/contiki/tools/cooja/dist/cooja.jar -nogui=$HOME/contiki/examples/ipv6/my-LFC-from-old/scenario/realsim/ladder_LF_realsim_gui_${scenario}.csc -contiki=$HOME/contiki/
    echo return to upper directory
