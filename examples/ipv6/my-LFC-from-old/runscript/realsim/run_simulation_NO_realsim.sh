...
do
    ...
    #pwd
    #echo re-write csc file
    #python xml_re_writer_seed_decide.py ladder_NO_realsim.csc $i
    #echo return to upper directory
    #cd ../..
    #pwd #should be in project home
    ...
    timeout -sKILL 7200 java -jar $HOME/contiki/tools/cooja/dist/cooja.jar -nogui=$HOME/contiki/examples/ipv6/my-LFC-from-old/scenario/realsim/ladder_NO_realsim_gui_${scenario}.csc -contiki=$HOME/contiki/
    echo return to upper directory
