...
do
    ...
    timeout -sKILL 3600 java -jar $HOME/contiki/tools/cooja/dist/cooja.jar -nogui=$HOME/contiki/examples/ipv6/my-LFC-from-old/scenario/realsim/ladder_NO-re8_realsim_gui_${scenario}.csc -contiki=$HOME/contiki/
    echo return to upper directory
