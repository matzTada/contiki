...
do
  ...
  do
    ...
    java -jar $HOME/contiki/tools/cooja/dist/cooja.jar -nogui=$HOME/contiki/examples/ipv6/my-LFC-from-old/scenario/udgm/ladder_LF_udgm.csc -contiki=$HOME/contiki/
    echo return to upper directory
    cd ..
    pwd
  done
