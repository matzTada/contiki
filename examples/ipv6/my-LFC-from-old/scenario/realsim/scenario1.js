...
TIMEOUT(6005000, log.log("Simulation time expired Time " + time + " PDR " + (total_receive_count / total_send_count) + " #send " + total_send_count +  " #receive " + total_receive_count + " #replication " + total_replication_count + " #elimination " + total_elimination_count +  "\n")); /* milliseconds. print last msg at timeout */
...
while(true){
    ...
    else if(flag1200 == 0){ if(time >= 1200000000){
      flag1200 = 1;
    ...
    else if(flag1800 == 0){ if(time >= 1800000000){
      flag1800 = 1;
      log.log("report link=80, PDR " + (receive_count/send_count) + " #s " + send_count + " #r " + receive_count + " #rep " + replication_count + " #eli " + elimination_count + "\n"); 
      log.log("setedge 70" + "\n"); send_count = 0; receive_count = 0; replication_count = 0; elimination_count = 0;
    }}
    else if(flag2400 == 0){ if(time >= 2400000000){
      flag2400 = 1;
      log.log("report link=70, PDR " + (receive_count/send_count) + " #s " + send_count + " #r " + receive_count + " #rep " + replication_count + " #eli " + elimination_count + "\n"); 
      log.log("setedge 60" + "\n"); send_count = 0; receive_count = 0; replication_count = 0; elimination_count = 0;
    }}
    else if(flag3000 == 0){ if(time >= 3000000000){
      flag3000 = 1; 
    ...
    else if(flag3600 == 0){ if(time >= 3600000000){
      flag3600 = 1;
    ...
    else if(flag4200 == 0){ if(time >= 4200000000){
      flag4200 = 1;
    ...
    else if(flag4800 == 0){ if(time >= 4800000000){
      flag4800 = 1;
    ...
    else if(flag5400 == 0){ if(time >= 5400000000){
      flag5400 = 1;
    ...
    else if(flag6000 == 0){ if(time >= 6000000000){
      flag6000 = 1;
