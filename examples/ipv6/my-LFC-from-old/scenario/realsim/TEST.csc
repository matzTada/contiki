<?xml version="1.0" ?><simconf>
  ...
  <plugin>
    ...
    <plugin_config>
      <scriptfile>[CONTIKI_DIR]/examples/ipv6/my-LFC-from-old/scenario/realsim/TEST_SCENARIO.js</scriptfile>
      <active>false</active>
    </plugin_config>
    <width>600</width>
    <z>0</z>
  ...
  <plugin>
    ...
    <plugin_config>
      <Filename>[CONTIKI_DIR]/examples/ipv6/my-LFC-from-old/scenario/realsim/TEST_SCENARIO.realsimfile</Filename>
      <Load>true</Load>
    </plugin_config>
    <width>396</width>
    <z>2</z>
