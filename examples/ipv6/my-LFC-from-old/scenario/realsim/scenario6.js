...
TIMEOUT(8708000, log.log("Simulation time expired Time " + time + " PDR " + (total_receive_count / total_send_count) + " #send " + total_send_count +  " #receive " + total_receive_count + " #replication " + total_replication_count + " #elimination " + total_elimination_count +  "\n")); /* milliseconds. print last msg at timeout */
...
while(true){
    ...
    else if(flag3 == 0){ if(time >= 1500000000){
      flag3 = 1;
    ...
    else if(flag4 == 0){ if(time >= 2100000000){
      flag4 = 1;
    ...
    else if(flag5 == 0){ if(time >= 2700000000){
      flag5 = 1;
    ...
    else if(flag6 == 0){ if(time >= 3300000000){
      flag6 = 1; 
    ...
    else if(flag7 == 0){ if(time >= 3900000000){
      flag7 = 1;
    ...
    else if(flag8 == 0){ if(time >= 4500000000){
      flag8 = 1;
    ...
    else if(flag9 == 0){ if(time >= 5100000000){
      flag9 = 1;
    ...
    else if(flag10 == 0){ if(time >= 5700000000){
      flag10 = 1;
    ...
    else if(flag11 == 0){ if(time >= 6300000000){
      flag11 = 1;
    ...
    else if(flag12 == 0){ if(time >= 6900000000){
      flag12 = 1;
    ...
    else if(flag13 == 0){ if(time >= 7500000000){
      flag13 = 1;
    ...
    else if(flag14 == 0){ if(time >= 8100000000){
      flag14 = 1;
    ...
    else if(flag15 == 0){ if(time >= 8700000000){
      flag15 = 1;
