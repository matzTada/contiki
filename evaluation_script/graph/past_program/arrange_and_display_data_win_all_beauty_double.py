...
for i in range(10):
	bp1 = plt.boxplot(pdr_no[i], positions=[6*i+0], widths=0.8, patch_artist=True)
	set_boxplot_color(bp1, color_no[0], color_no[1])
	bp2 = plt.boxplot(pdr_lf[i], positions=[6*i+1], widths=0.8, patch_artist=True)
	set_boxplot_color(bp2, color_lf[0], color_lf[1])
	bp1 = plt.boxplot(pdr_re2[i], positions=[6*i+2], widths=0.8, patch_artist=True)
	set_boxplot_color(bp1, color_re2[0], color_re2[1])
	bp2 = plt.boxplot(pdr_re4[i], positions=[6*i+3], widths=0.8, patch_artist=True)
	set_boxplot_color(bp2, color_re4[0], color_re4[1])
	bp1 = plt.boxplot(pdr_re6[i], positions=[6*i+4], widths=0.8, patch_artist=True)
	set_boxplot_color(bp1, color_re6[0], color_re6[1])
	bp2 = plt.boxplot(pdr_re8[i], positions=[6*i+5], widths=0.8, patch_artist=True)
...
for i in range(graph_x_min, graph_x_max):
	...
	xticks.append(str((i+1)*10))
	xticks.append(str((i+1)*10))
plt.xticks([i for i in range(6*graph_x_min,6*graph_x_max)], xticks, rotation=270) #must be changed correpoiding to the number of data
...
ax.bar([1], [0], color='white', edgecolor=color_re2[0], hatch=color_re2[1], label='ReTx=2')
ax.bar([1], [0], color='white', edgecolor=color_re4[0], hatch=color_re4[1], label='ReTx=4')
ax.bar([1], [0], color='white', edgecolor=color_re6[0], hatch=color_re6[1], label='ReTx=6')
ax.bar([1], [0], color='white', edgecolor=color_re8[0], hatch=color_re8[1], label='ReTx=8')
...
for i in range(10):
	bp1 = plt.boxplot(nrg_net_avg_no[i], positions=[6*i+0], widths=0.8, patch_artist=True)
	set_boxplot_color(bp1, color_no[0], color_no[1])
	bp2 = plt.boxplot(nrg_net_avg_lf[i], positions=[6*i+1], widths=0.8, patch_artist=True)
	set_boxplot_color(bp2, color_lf[0], color_lf[1])
	bp1 = plt.boxplot(nrg_net_avg_re2[i], positions=[6*i+2], widths=0.8, patch_artist=True)
	set_boxplot_color(bp1, color_re2[0], color_re2[1])
	bp2 = plt.boxplot(nrg_net_avg_re4[i], positions=[6*i+3], widths=0.8, patch_artist=True)
	set_boxplot_color(bp2, color_re4[0], color_re4[1])
	bp1 = plt.boxplot(nrg_net_avg_re6[i], positions=[6*i+4], widths=0.8, patch_artist=True)
	set_boxplot_color(bp1, color_re6[0], color_re6[1])
	bp2 = plt.boxplot(nrg_net_avg_re8[i], positions=[6*i+5], widths=0.8, patch_artist=True)
	set_boxplot_color(bp2, color_re8[0], color_re8[1])
...
for i in range(10):
	bp1 = plt.boxplot(jitter_no[i], positions=[6*i+0], widths=0.8, patch_artist=True)
	set_boxplot_color(bp1, color_no[0], color_no[1])
	bp2 = plt.boxplot(jitter_lf[i], positions=[6*i+1], widths=0.8, patch_artist=True)
	set_boxplot_color(bp2, color_lf[0], color_lf[1])
	bp1 = plt.boxplot(jitter_re2[i], positions=[6*i+2], widths=0.8, patch_artist=True)
	set_boxplot_color(bp1, color_re2[0], color_re2[1])
	bp2 = plt.boxplot(jitter_re4[i], positions=[6*i+3], widths=0.8, patch_artist=True)
	set_boxplot_color(bp2, color_re4[0], color_re4[1])
	bp1 = plt.boxplot(jitter_no[i], positions=[6*i+4], widths=0.8, patch_artist=True)
	set_boxplot_color(bp1, color_re6[0], color_re6[1])
	bp2 = plt.boxplot(jitter_lf[i], positions=[6*i+5], widths=0.8, patch_artist=True)
	set_boxplot_color(bp2, color_re8[0], color_re8[1])
...
ax.plot(x, pdr_avg_no, 'o-', label="default")
ax.plot(x, pdr_avg_lf, 'x-', label="Leapfrog")
ax.plot(x, pdr_avg_re2, '+-', label="ReTx=2")
ax.plot(x, pdr_avg_re4, '^-', label="ReTx=4")
ax.plot(x, pdr_avg_re6, 's-', label="ReTx=6")
ax.plot(x, pdr_avg_re8, 'D-', label="ReTx=8")

ax.set_xlabel('Link quality (%)')
ax.set_ylabel('Packet Delivery Ratio (%)')
ax.legend(ncol=2, loc="upper left")
fig.savefig("PDR_line" + ".png")
...
ax = fig.add_subplot(111)
x = np.arange(rx_min, rx_max+1, 10)
ax.plot(x, nrg_net_avg_avg_no, 'o-', label="default")
ax.plot(x, nrg_net_avg_avg_lf, 'x-', label="Leapfrog")
ax.plot(x, nrg_net_avg_avg_re2, '+-', label="ReTx=2")
ax.plot(x, nrg_net_avg_avg_re4, '^-', label="ReTx=4")
ax.plot(x, nrg_net_avg_avg_re6, 's-', label="ReTx=6")
ax.plot(x, nrg_net_avg_avg_re8, 'D-', label="ReTx=8")
ax.set_xlabel('Link quality (%)')
ax.set_ylabel('Average energy consumption of network (mW)')
ax.legend(ncol=2, loc="upper right")
fig.savefig("NRG_line" + ".png")
...
for i in range(10):
	bp1 = plt.boxplot(pdr_no[i], positions=[2*i+0], widths=0.8, patch_artist=True)
	set_boxplot_color(bp1, color_no[0], color_no[1])
	bp2 = plt.boxplot(pdr_lf[i], positions=[2*i+1], widths=0.8, patch_artist=True)
	set_boxplot_color(bp2, color_lf[0], color_lf[1])
...
for i in range(graph_x_min, graph_x_max):
	xticks.append(str((i+1)*10))
	xticks.append(str((i+1)*10))
plt.xticks([i for i in range(2*graph_x_min,2*graph_x_max)], xticks, rotation=270) #must be changed correpoiding to the number of data
...
for i in range(10):
	bp1 = plt.boxplot(nrg_net_avg_no[i], positions=[2*i+0], widths=0.8, patch_artist=True)
	set_boxplot_color(bp1, color_no[0], color_no[1])
	bp2 = plt.boxplot(nrg_net_avg_lf[i], positions=[2*i+1], widths=0.8, patch_artist=True)
	set_boxplot_color(bp2, color_lf[0], color_lf[1])
...
j = 0
for i in range(graph_x_min, graph_x_max):
	bp1 = zax.boxplot(nrg_net_avg_no[i], positions=[2*j+0], widths=0.8, patch_artist=True)
	set_boxplot_color(bp1, color_no[0], color_no[1])
	bp2 = zax.boxplot(nrg_net_avg_lf[i], positions=[2*j+1], widths=0.8, patch_artist=True)
	set_boxplot_color(bp2, color_lf[0], color_lf[1])
	j += 1
xticks = []
for i in range(graph_x_min, graph_x_max):
	xticks.append(str((i+1)*10))
	xticks.append(str((i+1)*10))
plt.xticks([i for i in range(0, 2*(graph_x_max-graph_x_min))], xticks, rotation=270) #must be changed correpoiding to the number of data
ax.set_xlabel('Link quality (%)')
ax.set_ylabel('Average energy consumption of network (mA)')

fig.savefig("NRG_simple" + ".png")
